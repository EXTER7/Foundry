...
public class GT_Utility {
	...
	public static boolean doSoundAtClient(String aSoundName, float aSoundStrength) {
		if (sPlayedSoundMap.contains(aSoundName) || isStringInvalid(aSoundName) || sCurrentPlayer == null || !sCurrentPlayer.worldObj.isRemote) return false;
	...
	public static boolean doSoundAtClient(String aSoundName, float aSoundStrength, float aSoundModulation, double aX, double aY, double aZ) {
		if (isStringInvalid(aSoundName) || sPlayedSoundMap.contains(aSoundName) || sCurrentPlayer == null || !sCurrentPlayer.worldObj.isRemote || !GregTech_API.gregtechmod.isClientSide()) return false;
