...
public class ModFoundry
{
  ...
  public void preInit(FMLPreInitializationEvent event)
  {
    ...
    LiquidMetalRegistry.RegisterLiquidMetal(config, "Iron", 3830, 9025, 1850, 15);
    LiquidMetalRegistry.RegisterLiquidMetal(config, "Gold", 3831, 9026, 1350, 15);
    LiquidMetalRegistry.RegisterLiquidMetal(config, "Copper", 3833, 9027, 1400, 15);
    LiquidMetalRegistry.RegisterLiquidMetal(config, "Tin", 3834, 9028, 550, 7);
    LiquidMetalRegistry.RegisterLiquidMetal(config, "Bronze", 3835, 9029, 1400, 15);
    LiquidMetalRegistry.RegisterLiquidMetal(config, "Electrum", 3837, 9030, 1350, 15);
    LiquidMetalRegistry.RegisterLiquidMetal(config, "Invar", 3838, 9031, 1850, 15);
    LiquidMetalRegistry.RegisterLiquidMetal(config, "Nickel", 3839, 9032, 1750, 15);
    LiquidMetalRegistry.RegisterLiquidMetal(config, "Zinc", 3840, 9033, 700, 15);
    LiquidMetalRegistry.RegisterLiquidMetal(config, "Brass", 3841, 9034, 1400, 15);
    LiquidMetalRegistry.RegisterLiquidMetal(config, "Silver", 3842, 9035, 1250, 15);
    LiquidMetalRegistry.RegisterLiquidMetal(config, "Steel", 3845, 9036, 1850, 15);
    LiquidMetalRegistry.RegisterLiquidMetal(config, "Lead", 3849, 9037, 650, 1);
