...
public class BlockAlloyMixer extends BlockContainer
{
  ...
  {
    TileEntityAlloyMixer te_aoc = (TileEntityAlloyMixer)world.getBlockTileEntity(x, y, z);
  ...
  {
    blockIcon = register.registerIcon("foundry:alloymixer_sides");
    icon_top = register.registerIcon("foundry:alloymixer_top");
    icon_bottom = register.registerIcon("foundry:alloymixer_bottom");
  }
  ...
  public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int par6, float par7, float par8, float par9)
  {
    ...
    {
      player.openGui(ModFoundry.instance, 2, world, x, y, z);
      return true;
    }
  }
