...
public class BlockMetalCaster extends BlockContainer
{
  ...
  public BlockMetalCaster(int id)
  {
    super(id, Material.rock);
    setHardness(1.0F);
    setResistance(8.0F);
    setStepSound(Block.soundStoneFootstep);
    setUnlocalizedName("metalCaster");
  ...
  {
    TileEntityMetalCaster te_aoc = (TileEntityMetalCaster)world.getBlockTileEntity(x, y, z);
  ...
  {
      blockIcon = register.registerIcon("foundry:caster_sides");
      icon_top = register.registerIcon("foundry:caster_top");
  }
  ...
  public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int par6, float par7, float par8, float par9)
  {
    ...
    {
      player.openGui(ModFoundry.instance, 1, world, x, y, z);
      return true;
    }
  }
