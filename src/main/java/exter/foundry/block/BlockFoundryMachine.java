...
public class BlockFoundryMachine extends Block implements ITileEntityProvider,IBlockVariants
{
  ...
  {
    CRUCIBLE_BASIC(0, "crucible_basic", "machine_crucible_basic"),
    CASTER(1, "caster", "machine_caster"),
    ALLOYMIXER(2, "alloymixer", "machine_alloy_mixer"),
    INFUSER(3, "infuser", "machine_infuser"),
    MATERIALROUTER(4, "router", "machine_material_router"),
    ATOMIZER(5, "atomizer", "machine_atomizer"),
    INDUCTIONHEATER(6, "heater_induction", "machine_induction_heater"),
    CRUCIBLE_ADVANCED(7, "crucible_advanced", "machine_crucible_advanced"),
    CRUCIBLE_STANDARD(8, "crucible_standard", "machine_crucible_standard"),
    ALLOYING_CRUCIBLE(9, "alloying_crucible", "machine_alloying_crucible");
